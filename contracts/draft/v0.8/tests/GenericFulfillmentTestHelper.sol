...
contract GenericFulfillmentTestHelper is ChainlinkExternalFulfillmentCompatible {
    ...
    function setExternalPendingRequest(address _oracleAddr, bytes32 _requestId) external {
    ...
    function fulfillBool(bytes32 _requestId, bool _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledBool(_requestId, _result);
    }

    // Function signature: 0xa0c29e01
    function fulfillBoolArray(bytes32 _requestId, bool[] calldata _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledBoolArray(_requestId, _result);
    }

    // Function signature: 0x0941dfb3
    function fulfillBytes32(bytes32 _requestId, bytes32 _result) external recordFulfillment(_requestId) {
    ...
    function fulfillBytes(bytes32 _requestId, bytes calldata _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledBytes(_requestId, _result);
    }

    // Function signature: 0xe5a2a1f8
    function fulfillBytesArray(bytes32 _requestId, bytes[] memory _results) external recordFulfillment(_requestId) {
        emit RequestFulfilledBytesArray(_requestId, _results);
    }

    // Function signature: 0x5eb6f000
    function fulfillInt256(bytes32 _requestId, int256 _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledInt256(_requestId, _result);
    }

    // Function signature: 0x5fea1383
    function fulfillInt256Array(bytes32 _requestId, int256[] calldata _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledInt256Array(_requestId, _result);
    }

    // Function signature: 0xa6bdca07
    function fulfillString(bytes32 _requestId, string calldata _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledString(_requestId, _result);
    }

    // Function signature: 0x86666ba9
    function fulfillStringArray(bytes32 _requestId, string[] memory _result) external recordFulfillment(_requestId) {
        emit RequestFulfilledStringArray(_requestId, _result);
    }

    // Function signature: 0x7c1f72a0
    function fulfillUint256(bytes32 _requestId, uint256 _result) external recordFulfillment(_requestId) {
